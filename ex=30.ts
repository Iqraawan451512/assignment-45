...
• Otherwise, print a generic greeting, such as Hello Eric,
 ...
 let statement=["sara","arsalan","admin","iqra","danish"];

 for( let i=0 ; i < statement.length;i++ ){
    if(statement[i]=="admin"){
        console.log(`hello ${statement[i]} ,would you like to see a status report?\n`)
    }
else{
    console.log(`hello ${statement[i]},thank you for logging in again`)
 }
