...
console.log(
  `sorry Mr.${friend1} your invitation is canclled .now you are not invited`
);

let friend2 = invitation.pop();
console.log(
  `sorry! Miss ${friend2} your invitation is canclled .Now your not invited`
);
let friend3 = invitation.pop();
console.log(
  `sorry! MISS ${friend3} Your invatation in cancalled .Now you are not invited`
);
let friend4 = invitation.pop();
console.log(
  `sorry! MISS ${friend4} Your invatation in cancalled .Now you are not invited`
);
