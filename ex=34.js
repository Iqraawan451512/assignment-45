...
*/
var pizza = ["pepperoni pizza", "BBQ pizza", "fajita pizza"];
for (var i = 0; i < pizza.length; i++) {
    console.log(" ".concat(i, " ").concat(pizza[i], " \n"));
}
//requirnment 2 prints name and message
for (var i = 0; i < pizza.length; i++) {
    console.log("i like to eat ".concat(pizza[i]));
}
console.log("i really like pizza. pizza is ultimate convenience food .its quick ,tasty and always satisfying.with its easy turnover time \n");
